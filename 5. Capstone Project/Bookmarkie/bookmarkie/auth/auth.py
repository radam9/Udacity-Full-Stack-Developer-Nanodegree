...
# load the .flaskenv files (enviromental variables)
dotenv_path = os.path.join(
    os.path.dirname(os.path.dirname(os.path.dirname(__file__))), ".flaskenv"
)
...
# Generate the url required to login to auth0
# def generate_auth_url():
#     url = "https://"
#     url += AUTH0_DOMAIN
#     url += "/authorize?"
#     url += "audience=" + AUTH0_AUDIENCE + "&"
#     url += "response_type=token&"
#     url += "client_id=" + AUTH0_CLIENT_ID + "&"
#     url += "redirect_uri=" + AUTH0_CALLBACK_URL
#     return url
